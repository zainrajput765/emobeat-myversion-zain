  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "bg-popover text-popover-foreground ... overflow-x-hidden overflow-y-auto rounded-md border p-1 shadow-md",
          className
        )}
        {...props}
      />
...
function DropdownMenuSubContent({ className, ...props }) {
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn("bg-popover text-popover-foreground ... rounded-md border p-1 shadow-lg", className)}
      {...props}
    />
  );
}
